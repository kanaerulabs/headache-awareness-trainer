...
test.describe("Authentication Navigation", () => {
  test.describe("Unauthenticated Navigation", () => {
    ...
    test("should handle multiple navigation attempts when unauthenticated", async ({
      page,
    }) => {
  ...
  test.describe("Login Page Navigation", () => {
    ...
    test("should stay on login page when accessing directly", async ({
      page,
    }) => {
      await page.goto("/login");
    ...
    test("should handle browser back button from login page", async ({
      page,
    }) => {
      // Start at login page
      await page.goto("/login");
    ...
    test("should allow navigation to public routes from login", async ({
      page,
    }) => {
      await page.goto("/login");
  ...
  test.describe("Authenticated Navigation", () => {
    ...
    test.skip("should redirect from login to home when authenticated", async ({
      page,
    }) => {
    ...
    test.skip("should allow navigation between protected routes", async ({
      page,
    }) => {
      // Prerequisite: User is authenticated
    ...
    test.skip("should allow direct access to protected routes", async ({
      page,
    }) => {
      // Prerequisite: User is authenticated
    ...
    test.skip("should handle browser back button when authenticated", async ({
      page,
    }) => {
      // Prerequisite: User is authenticated
    ...
    test.skip("should handle browser forward button when authenticated", async ({
      page,
    }) => {
      // Prerequisite: User is authenticated
    ...
    test.skip("should persist authentication across multiple navigations", async ({
      page,
    }) => {
      // Prerequisite: User is authenticated
  ...
  test.describe("Deep Linking with CallbackUrl", () => {
    ...
    test("should preserve callbackUrl with query parameters", async ({
      page,
    }) => {
    ...
    test("should preserve callbackUrl with hash fragments", async ({
      page,
    }) => {
    ...
    test.skip("should redirect to callbackUrl after successful login", async ({
      page,
    }) => {
  ...
  test.describe("Navigation Performance", () => {
    ...
    test("should redirect quickly from protected route to login", async ({
      page,
    }) => {
    ...
    test("should not cause visible flashing during redirect", async ({
      page,
    }) => {
  ...
  test.describe("Client-Side Navigation", () => {
    test.skip("should handle Next.js Link navigation when authenticated", async ({
      page,
    }) => {
      // Prerequisite: User is authenticated
    ...
    test.skip("should handle router.push() navigation when authenticated", async ({
      page,
    }) => {
      // Prerequisite: User is authenticated
