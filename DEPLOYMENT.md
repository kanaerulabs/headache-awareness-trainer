...
> ⚠️ **Never commit real credentials to the repository!** Get credentials from your Google Cloud Console.

> **Note:** `NEXTAUTH_URL` is automatically inferred by NextAuth.js v5 on Vercel, so it's no longer required.
...
### State Management (`src/interface-adapters/store/auth/`)
...
**Production URL:** https://headache-awareness-trainer.vercel.app
